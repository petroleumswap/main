...
const sttaddr = "0x0b97f98cc0590652363204f5423e95baec9dc03f";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x0b97f98cc0590652363204f5423e95baec9dc03f";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://petroleumswap.com?ref=' + document.getElementById('refaddress').value;
        }
    }
}
